...
function setup() {
  ...
  jump.position(windowWidth/2,windowHeight/2+100)
  
  trex = createSprite(50,windowHeight/2-10,20,50);
  
  trex.addAnimation("running", trex_running);
  trex.addAnimation("collided", trex_collided);
  trex.scale = 0.5;
  
  ground = createSprite(windowWidth/2,windowHeight/2+10,windowWidth,20);
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(windowWidth,windowHeight/2-5,10,40);
    //obstacle.debug = true;
